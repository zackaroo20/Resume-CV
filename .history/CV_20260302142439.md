...
<span class="iconify" data-icon="charm:person"></span> [example.com](https://example.com/)
  : <span class="iconify" data-icon="tabler:brand-github"></span>[ https://github.com/zackaroo20](https://github.com/zackaroo20)
  : <span class="iconify" data-icon="tabler:phone"></span>438-368-1790‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ 

<span class="iconify" data-icon="ic:outline-location-on"></span> Montreal, Canada
  : <span class="iconify" data-icon="tabler:brand-linkedin"></span> [linkedin.com/in/example](https://linkedin.com/in/example/)
  : <span class="iconify" data-icon="tabler:mail"></span> [tomjerrysc@gmail.com](mailto:tomjerrysc@gmail.com)

## Technical Skills

**Programming Languages:**   C#, / <span class="iconify" data-icon="vscode-icons:file-type-js-official"></span> JavaScript, / <span class="iconify" data-icon="vscode-icons:file-type-typescript-official"></span> TypeScript, <span class="iconify" data-icon="vscode-icons:file-type-html"></span> HTML, / <span class="iconify" data-icon="vscode-icons:file-type-css"></span> CSS
## Techinical Skills
